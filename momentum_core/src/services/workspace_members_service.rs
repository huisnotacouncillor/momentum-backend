...
impl WorkspaceMembersService {
    ...
    ) -> Result<Vec<crate::services::workspace_members::types::WorkspaceMemberInfo>, AppError> {
    ...
    pub fn get_workspace_members_with_search(
        ...
        for member in members {
            ...
            member_infos.push(crate::services::workspace_members::types::WorkspaceMemberInfo {
                id: member.user_id,
    ...
    pub fn get_members_and_invitations(
        ...
        role: Option<crate::db::models::workspace_member::WorkspaceMemberRole>,
        user_id: Option<uuid::Uuid>,
    ) -> Result<crate::services::workspace_members::types::MembersAndInvitations, AppError> {
        // Get members
        let members =
        ...
        Ok(crate::services::workspace_members::types::MembersAndInvitations {
            members,
            invitations,
        })
    }
