...
impl WorkflowsService {
    ...
    pub fn update(
        ...
        _ctx: &RequestContext,
        workflow_id: uuid::Uuid,
        req: &crate::db::models::workflow::UpdateWorkflowRequest,
    ) -> Result<Workflow, AppError> {
    ...
    pub fn create_team_default_state(
        ...
        _ctx: &RequestContext,
        team_id: uuid::Uuid,
        req: &crate::services::workflows::types::CreateTeamDefaultStateRequest,
    ) -> Result<WorkflowState, AppError> {
        validate_create_state(&req.name, req.position)?;
        let new_state = NewWorkflowState {
    ...
    pub fn update_team_default_state(
        ...
        team_id: uuid::Uuid,
        state_id: uuid::Uuid,
        req: &crate::services::workflows::types::UpdateTeamDefaultStateRequest,
    ) -> Result<WorkflowState, AppError> {
