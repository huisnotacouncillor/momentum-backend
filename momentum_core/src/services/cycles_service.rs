...
impl CyclesService {
    ...
    pub fn create(
        ...
        _ctx: &RequestContext,
        req: &crate::services::cycles::types::CreateCycleRequest,
    ...
    pub fn update(
        ...
        _ctx: &RequestContext,
        cycle_id: uuid::Uuid,
        req: &crate::services::cycles::types::UpdateCycleRequest,
    ) -> Result<Cycle, AppError> {
        let _existing =
            CyclesRepo::find_by_id(conn, cycle_id)?.ok_or_else(|| AppError::not_found("cycle"))?;
    ...
    pub fn get_stats(
        ...
        _ctx: &RequestContext,
        cycle_id: uuid::Uuid,
    ) -> Result<crate::services::cycles::types::CycleStats, AppError> {
        let cycle =
            CyclesRepo::find_by_id(conn, cycle_id)?.ok_or_else(|| AppError::not_found("cycle"))?;
        ...
        Ok(crate::services::cycles::types::CycleStats {
            id: cycle.id,
            name: cycle.name,
