...
impl InvitationsService {
    ...
    pub fn get_user_invitations(
        ...
        email: Option<String>,
    ) -> Result<Vec<crate::services::invitations::types::InvitationInfo>, AppError> {
        ...
        for invitation in invitations {
            ...
            let processed_workspace_logo_url = workspace
                ...
                .as_ref()
                .map(|url| asset_helper.process_url(url));
            invitation_infos.push(crate::services::invitations::types::InvitationInfo {
                id: invitation.id,
    ...
    pub fn get_by_id(
        ...
        asset_helper: &crate::utils::AssetUrlHelper,
        invitation_id: uuid::Uuid,
    ) -> Result<crate::services::invitations::types::InvitationInfo, AppError> {
        ...
        let processed_workspace_logo_url = workspace
            ...
            .as_ref()
            .map(|url| asset_helper.process_url(url));
        Ok(crate::services::invitations::types::InvitationInfo {
            id: invitation.id,
            email: invitation.email,
            role: invitation.role,
            status: invitation.status,
