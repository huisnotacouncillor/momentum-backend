...
pub use momentum_core::services::project_statuses::types::UpdateProjectStatusRequest;
...
pub async fn create_project_status(
    ...
    let category_enum = match payload.category.as_str() {
        "backlog" => momentum_core::db::models::project_status::ProjectStatusCategory::Backlog,
        "planned" => momentum_core::db::models::project_status::ProjectStatusCategory::Planned,
        "in_progress" => momentum_core::db::models::project_status::ProjectStatusCategory::InProgress,
        "completed" => momentum_core::db::models::project_status::ProjectStatusCategory::Completed,
        "canceled" => momentum_core::db::models::project_status::ProjectStatusCategory::Canceled,
        _ => momentum_core::db::models::project_status::ProjectStatusCategory::Backlog,
    };

    let model_request = momentum_core::db::models::project_status::CreateProjectStatusRequest {
        name: payload.name,
